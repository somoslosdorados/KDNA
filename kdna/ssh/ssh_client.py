...
class SSHClient:
    ...
    def disconnect(self):
        ...
        This method sets the connection attribute to None, effectively disconnecting from the current connection.
    ...
    def run(self, command: str):
        ...
        This method executes the specified command on the remote connection using the `run` method of the connection object.
        The `warn` parameter is set to True, which means that a warning will be issued if the command execution fails.
